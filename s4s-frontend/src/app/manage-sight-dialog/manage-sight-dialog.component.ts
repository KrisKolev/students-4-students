...
export class ManageSightDialogComponent implements OnInit {
  ...
  @ViewChild('mapInfo', { static: false }) infoWindow: MapInfoWindow;
  ...
  checkFormValidity(){
    this.validForm = this.addSightForm.valid && this.rating!=undefined && this.mapMarkers.length>1 && this.labels.length>0
  }
